...
📌 이 방식은 네 코드의 isExist() 함수에서도 사용되고 있다 

user_demo

3️⃣ 빈 객체 확인 방법 ② for문(for...in)
🔹 개념
...
5️⃣ 왜 “빈 객체 확인”이 중요한가? (login 코드 기준)
...
7️⃣ app.route()를 쓰는 이유 (channel_demo.js)
🔹 기존 방식
app.get('/channels', ...)
app.post('/channels', ...)
